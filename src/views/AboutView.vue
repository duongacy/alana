    ...
    <main class="isolate">
      ...
      <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <h2 class="text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">Our mission</h2>
            ...
            <div class="lg:flex lg:flex-auto lg:justify-center">
              <dl class="w-64 space-y-8 xl:w-80">
                <div v-for="stat in stats" :key="stat.label" class="flex flex-col-reverse gap-y-4">
                  ...
                  <dd class="text-5xl font-semibold tracking-tight text-gray-800">
                    {{ stat.value }}
                  </dd>
                </div>
              </dl>
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">Our values</h2>
        ...
        >
          <div v-for="value in values" :key="value.name">
            <dt class="font-semibold text-gray-800">{{ value.name }}</dt>
      ...
      <div class="relative isolate -z-10 mt-32 sm:mt-48">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 class="text-center text-lg font-semibold leading-8 text-gray-800">
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">Our team</h2>
          <p class="mt-6 text-lg leading-8 text-gray-600">
        ...
        >
          <li v-for="person in team" :key="person.name">
            ...
            <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-800">
              {{ person.name }}
            </h3>
...
const pages = [{ name: 'About', to: getRoute('about').path, current: true }]
